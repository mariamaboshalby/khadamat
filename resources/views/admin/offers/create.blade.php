...
<div style="max-width: 800px; margin: 0 auto;">
    <div style="margin-bottom: 30px; display: flex; justify-content: space-between; align-items: center;">
        <div>
            <h1 style="font-size: 28px; margin: 0 0 10px; color: #2d3748; font-weight: 700;">إضافة عرض جديد</h1>
            <p style="color: #718096; margin: 0;">إنشاء عرض ترويجي جديد</p>
        </div>
    ...
    <div class="card" style="padding: 0; overflow: hidden; border: none; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);">
        <div style="background: linear-gradient(135deg, #e53e3e 0%, #0b5f8a 100%); padding: 24px; color: white;">
            <div style="display: flex; align-items: center; gap: 16px;">
                ...
                <div>
                    <h3 style="font-size: 20px; font-weight: 700; margin: 0 0 4px;">بيانات العرض</h3>
                    <p style="margin: 0; opacity: 0.9; font-size: 14px;">يرجى ملء جميع الحقول المطلوبة بدقة</p>
                </div>
            </div>
        </div>

        <form method="POST" action="{{ route('admin.offers.store') }}" style="padding: 32px;">
            @csrf
            ...
            <div style="margin-bottom: 32px;">
                <h4 style="font-size: 16px; color: #4a5568; font-weight: 700; margin-bottom: 20px; padding-bottom: 10px; border-bottom: 2px solid #f7fafc;">
                    <span style="color: #10b981;">01.</span> تفاصيل العرض
                </h4>
            ...
            <div style="margin-bottom: 32px;">
                <h4 style="font-size: 16px; color: #4a5568; font-weight: 700; margin-bottom: 20px; padding-bottom: 10px; border-bottom: 2px solid #f7fafc;">
                    <span style="color: #10b981;">02.</span> تفاصيل الخصم
                </h4>
            ...
            <div style="margin-bottom: 32px;">
                <h4 style="font-size: 16px; color: #4a5568; font-weight: 700; margin-bottom: 20px; padding-bottom: 10px; border-bottom: 2px solid #f7fafc;">
                    <span style="color: #10b981;">03.</span> الأيقونة
                </h4>
